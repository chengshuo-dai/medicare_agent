...
PHASE_META: dict[InterviewPhase, dict[str, str]] = {
    InterviewPhase.HPI_ONSET:     {"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_QUALITY:   {"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_LOCATION:  {"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_SEVERITY:  {"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_TIMING:    {"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_AGGRAVATE: {"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_ASSOCIATED:{"cat": "HPI", "colloquial": "Symptoms"},
    InterviewPhase.HPI_TREATMENT: {"cat": "HPI", "colloquial": "Visit History"},
    InterviewPhase.PMH_CHRONIC:   {"cat": "PMH", "colloquial": "Health Status"},
    InterviewPhase.PMH_SURGERY:   {"cat": "PMH", "colloquial": "Health Status"},
    InterviewPhase.PMH_INFECTION: {"cat": "PMH", "colloquial": "Health Status"},
    InterviewPhase.PMH_ALLERGY:   {"cat": "PMH", "colloquial": "Allergies"},
    InterviewPhase.PS_LIFESTYLE:  {"cat": "Personal History", "colloquial": "Lifestyle"},
    InterviewPhase.PS_OCCUPATION: {"cat": "Personal History", "colloquial": "Work & Life"},
    InterviewPhase.PS_TRAVEL:     {"cat": "Personal History", "colloquial": "Travel History"},
    InterviewPhase.PS_GENERAL:    {"cat": "Personal History", "colloquial": "General"},
    InterviewPhase.PS_CHILD:      {"cat": "Personal History", "colloquial": "Child Development"},
    InterviewPhase.PS_FEMALE:     {"cat": "Personal History", "colloquial": "Women's Health"},
    InterviewPhase.FH_GENETIC:    {"cat": "Family History", "colloquial": "Family Health"},
    InterviewPhase.FH_SIMILAR:    {"cat": "Family History", "colloquial": "Family Health"},
    InterviewPhase.MED_CURRENT:   {"cat": "Medication History", "colloquial": "Medications"},
    InterviewPhase.MED_RECENT:    {"cat": "Medication History", "colloquial": "Medications"},
}
