...
class LLMProviderConfigBase(BaseModel):
    ...
    priority: int = Field(default=0, ge=0, le=100, description="Fallback priority: lower = higher priority")
...
class LLMProviderConfigUpdate(BaseModel):
    ...
    priority: int | None = Field(None, ge=0, le=100, description="Fallback priority")
