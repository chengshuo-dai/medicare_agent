    ...
    return (
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Typography variant="caption" sx={{ color: '#2C3E2D' }}>Analyzing</Typography>
        </Box>
      </Paper>
    );
  }
    ...
    return (
      ...
      >
        <Box sx={{ p: 1.5, display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Typography sx={{ fontSize: 14 }}>✅</Typography>
          <Typography variant="caption" sx={{ color: '#2F855A' }}>Analyzed</Typography>
        </Box>
        {report && (
          <Box sx={{ px: 1, pb: 1 }}>
  ...
  if (status === 'failed') {
    return (
      ...
      >
        ...
        {error && (
          <Typography variant="caption" sx={{ color: '#6B7D6B', mt: 0.5, display: 'block', ml: 3 }}>
            {error}
          </Typography>
        )}
      </Paper>
